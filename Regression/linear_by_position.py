...
for _ in range(100):
    ...
    # dataset = pd.read_csv("tempBelow5.csv")
    # dataset = pd.read_csv("temp5to6.csv")
    dataset = pd.read_csv("temp6to7.csv")
    # dataset = pd.read_csv("temp7to8.csv")
    # dataset = pd.read_csv("temp8to9.csv")
    # dataset = pd.read_csv("temp9to10.csv")
    # dataset = pd.read_csv("temp10to11.csv")
    # dataset = pd.read_csv("temp11to12.csv")
    # dataset = pd.read_csv("tempAbove12.csv")
    ...
    # print(data)
    with open("coeff.csv", "a", newline="") as f:
    ...
    # model_diff = pd.DataFrame({"Actual": y_test, "Predict": y_predict})
    # print(model_diff.head(10))
